  ...
  return (
    <>
      <div id="about" className="about-me-ctn">
        ...
        successful in the tech industry.I love building things and while hard engineering problems are often fun to tackle, I'm most attracted to soliving real
